...
from default_onnxruntime_inference_handler import DefaultONNXRuntimeInferenceHandler
...
class HandlerService(DefaultHandlerService):
    ...
    def __init__(self):
        ...
        transformer = Transformer(default_inference_handler=DefaultONNXRuntimeInferenceHandler())
